    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SessionId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    EntryDt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    PaymentDt = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    ExitDt = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PastSessions", x => x.SessionId);
                    table.ForeignKey(
                        name: "FK_PastSessions_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                ...
                {
                    { 1L, null, "Owner", "OWNER" },
                    { 2L, null, "CommonUser", "COMMONUSER" }
                });

            migrationBuilder.InsertData(
                table: "Tariffs",
                columns: new[] { "TariffId", "Minutes", "Rate" },
                values: new object[,]
                {
                    { 1, 15, 0m },
                    { 2, 60, 50m },
